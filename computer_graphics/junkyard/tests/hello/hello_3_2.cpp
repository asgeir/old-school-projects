...
void init()
{
    ...
    ShaderInfo shaders[] = {
        { GL_VERTEX_SHADER, "../tests/hello/hello_3_2.vert" },
        { GL_FRAGMENT_SHADER, "../tests/hello/hello_3_2.frag" },
        { GL_NONE, NULL }
    };

    GLuint program = loadShaders(shaders);
    glUseProgram(program);
    mTransformIndex = glGetUniformLocation(program, "mTransform");
...
void display()
{
    ...
    if (mTransformIndex != -1) {
        ...
        glUniformMatrix2fv(mTransformIndex, 1, GL_FALSE, rotation.data());
    }
