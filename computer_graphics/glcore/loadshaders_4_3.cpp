    ...
    GLuint geometryShaderID, GLenum inGeomType, GLenum outGeomType, GLuint maxOutVerts)
{
    ...
    if (geometryShaderID) {
        ...
        glProgramParameteri(programID, GL_GEOMETRY_INPUT_TYPE, inGeomType);
        glProgramParameteri(programID, GL_GEOMETRY_OUTPUT_TYPE, outGeomType);
        glProgramParameteri(programID, GL_GEOMETRY_VERTICES_OUT, maxOutVerts);
    }
