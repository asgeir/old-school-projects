...
switch (app.get('env')) {
case 'development':
  mongoose.connect('mongodb://localhost/asgeirb09verkefni10', dbOptions);
  break;
...
switch (app.get('env')) {
case 'development':
  initSearch('localhost:9200', searchOptions);
  break;

case 'production':
  initSearch(process.env.SEARCH_CONNECTION_STRING, searchOptions);
  break;
...
apiRouter.use('/companies', require('./controllers/company'));
